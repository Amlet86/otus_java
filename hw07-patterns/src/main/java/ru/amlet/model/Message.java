...
public class Message implements Cloneable {
    ...
    private Message(long id, String field1, String field2, String field3, String field4, String field5, String field6,
                    String field7, String field8, String field9, String field10, String field11, String field12, ObjectForMessage field13) {
        this.id = id;
        this.field1 = field1;
        this.field2 = field2;
        this.field3 = field3;
    ...
    public Builder toBuilder() {
        return new Builder(id, field1, field2, field3, field4, field5, field6,
    ...
    public Message clone() {
        return this.toBuilder().field13(this.field13).build();
    }
